...
import { Modal, Typography, Button, ButtonGroup, Grid, Box, CircularProgress, useMediaQuery, Rating, recomposeColor } from '@mui/material'
  ...
  return (
    <Grid container className={classes.containerSpaceAround}>
      ...
      <Grid item container direction='column' lg={7}>
        ...
        <Grid item className={classes.containerSpaceAround}>
          <Box display='flex' align='center'>
            ...
            <Typography variant='subtitle1' gutterBottom style={{marginLeft: '10px'}}>{Math.round(data?.vote_average * 10) /10} / 10</Typography>
          </Box>
      ...
      <Box marginTop='5rem' width='100%'>
        ...
        {/* Loop through the reccommneded movies ... */}
        {recommendations 
